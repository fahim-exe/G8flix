  ...
  <body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <a href="#" class="navbar-brand"> <img src="images/logos.png" alt=""> </a>
            ...
            <ul class="navbar-nav">
              ...
              if (isset($_SESSION['id'])) {
                ...
                else {echo "<li class='nav-item'> <a href='review.php' class='nav-link'>Leave Review</a> </li>";
                }
              }
