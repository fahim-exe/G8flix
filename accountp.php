   ...
   <body>
     <header>
      ...
      echo"  <form  action='update.php' method='POST'>
          ...
          <br>
	  <label><b>Subscribed Package: </b></label>
          <input type='text' class='from-control' placeholder='Subcription Package' name='pack' value='".$result['subscription']."'><br>
	  <br>
          <label><b>Payment Method : </b></label>
          <input type='text' class='from-control' placeholder='Enter Payment Method' name='pay' value='".$result['payment']."'><br>
	  <br>
