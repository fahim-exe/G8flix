 ...
 <body>
   <header>
     <div class="container-fluid">
       ...
       <div class="container">
         ...
         <div class="jumbotron">
           ...
           <p>Register and watch your favourite movies from home. </p> <br>
	...
	<div class="form-group" >
               <label for="pack"> <br>Subscription Package </label>
               <div class="row">
                   ...
                   <select class="form-control" name='package'>
                     ...
                     <option value='Movie Fan'>Movie Fan</option>
                     <option value='Movie Fanatic'>Movie Fanatic</option>
                     <option value='Movie Devotee'>Movie Devotee</option>

                 </select>
               </div><div class="form-group" >
               <label for="pay"> <br>Payment Method </label>
               <div class="row">
